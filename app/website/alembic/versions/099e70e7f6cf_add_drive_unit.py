...
def upgrade() -> None:
    ...
    op.create_foreign_key("adv_drive_unit_id_fkey", 'adv', 'drive_unit', ['drive_unit_id'], ['id'], ondelete='SET NULL')
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint("adv_drive_unit_id_fkey", 'adv', type_='foreignkey')
